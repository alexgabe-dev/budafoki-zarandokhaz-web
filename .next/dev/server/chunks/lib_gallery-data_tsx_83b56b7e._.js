module.exports = [
"[project]/lib/gallery-data.tsx [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const allExhibitions = [
    {
        ...
        details: {
            ...
            curatorNote: "A sorozat a fény és sötét dialógusát vizsgálja. A képek helyszíni fotó- és skiccanyagból, valamint műtermi kísérletekből születtek."
        }
    },
    {
        id: 2,
        ...
        details: {
            ...
            curatorNote: "A tájak hangulatát gyors jegyzetek és több rétegű akvarell felületek teremtik meg. A sorozat a borvidékek karakterét emeli ki."
        }
    },
    {
        id: 3,
        ...
        details: {
            ...
            curatorNote: "A kiállítás a személyes hit és társadalmi kérdések metszéspontjaira reflektál. A művek különböző városi és műhelyszituációkban készültek."
        }
    }
];
function getExhibition(slug) {
    return allExhibitions.find((e)=>e.slug === slug);
}
}),
];

//# sourceMappingURL=lib_gallery-data_tsx_83b56b7e._.js.map