    ...
    <section className="relative py-24 md:py-32 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Mi történik a<span className="text-primary"> Zarándokházban?</span>
          </h1>
          ...
          >
            Tartsd magad naprakészen a legfrissebb eseményekkel, programokkal és újdonságokkal. Légy részese a
            Zarándokház közösségének!
          </p>
